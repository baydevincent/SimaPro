...
function createFalsableFormatter(input) {
    return input === false ? null : Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__["createFormatter"])(input);
}
...
class ListViewHeaderRow extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["BaseComponent"] {
    constructor() {
        super(...arguments);
        this.state = {
            textId: Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["getUniqueDomId"])(),
        };
    }
    render() {
        ...
        let dayMeta = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["getDateMeta"])(dayDate, todayRange);
        // will ever be falsy?
        ...
        let renderProps = Object.assign({ date: dateEnv.toDate(dayDate), view: viewApi, textId,
            text,
            sideText, navLinkAttrs: Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["buildNavLinkAttrs"])(this.context, dayDate), sideNavLinkAttrs: Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["buildNavLinkAttrs"])(this.context, dayDate, 'day', false) }, dayMeta);
        // TODO: make a reusable HOC for dayHeader (used in daygrid/timegrid too)
        return (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["ContentContainer"], { elTag: "tr", elClasses: [
                'fc-list-day',
                ...Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["getDayClassNames"])(dayMeta, theme),
            ], elAttrs: {
                'data-date': Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["formatDayString"])(dayDate),
            }, renderProps: renderProps, generatorName: "dayHeaderContent", customGenerator: options.dayHeaderContent, defaultGenerator: renderInnerContent, classNameGenerator: options.dayHeaderClassNames, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, (InnerContent) => ( // TODO: force-hide top border based on :first-child
        Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("th", { scope: "colgroup", colSpan: 3, id: cellId, "aria-labelledby": textId },
...
function renderInnerContent(props) {
    return (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null,
        props.text && (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("a", Object.assign({ id: props.textId, className: "fc-list-day-text" }, props.navLinkAttrs), props.text)),
        props.sideText && ( /* not keyboard tabbable */Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("a", Object.assign({ "aria-hidden": true, className: "fc-list-day-side-text" }, props.sideNavLinkAttrs), props.sideText))));
}
...
class ListViewEventRow extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["BaseComponent"] {
    render() {
        ...
        return (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["EventContainer"], Object.assign({}, props, { elTag: "tr", elClasses: [
                'fc-list-event',
                seg.eventRange.def.url && 'fc-event-forced-url',
            ], defaultGenerator: () => renderEventInnerContent(seg, context) /* weird */, seg: seg, timeText: "", disableDragging: true, disableResizing: true }), (InnerContent, eventContentArg) => (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null,
            buildTimeContent(seg, timeFormat, context, timeHeaderId, dateHeaderId),
            Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("td", { "aria-hidden": true, className: "fc-list-event-graphic" },
                Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("span", { className: "fc-list-event-dot", style: {
                        borderColor: eventContentArg.borderColor || eventContentArg.backgroundColor,
                    } })),
            Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(InnerContent, { elTag: "td", elClasses: ['fc-list-event-title'], elAttrs: { headers: `${eventHeaderId} ${dateHeaderId}` } })))));
    }
}
function renderEventInnerContent(seg, context) {
    let interactiveAttrs = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["getSegAnchorAttrs"])(seg, context);
    return (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("a", Object.assign({}, interactiveAttrs), seg.eventRange.def.title));
}
function buildTimeContent(seg, timeFormat, context, timeHeaderId, dateHeaderId) {
    ...
    if (options.displayEventTime !== false) {
        ...
        if (eventDef.allDay) {
        ...
        else if (Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["isMultiDayRange"])(seg.eventRange.range)) { // TODO: use (!isStart || !isEnd) instead?
            if (seg.isStart) {
                timeText = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["buildSegTimeText"])(seg, timeFormat, context, null, null, eventInstance.range.start, seg.end);
            }
            else if (seg.isEnd) {
                timeText = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["buildSegTimeText"])(seg, timeFormat, context, null, null, seg.start, eventInstance.range.end);
            }
            else {
                doAllDay = true;
            }
            ...
            timeText = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["buildSegTimeText"])(seg, timeFormat, context);
        }
        if (doAllDay) {
            let renderProps = {
            ...
            return (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["ContentContainer"], { elTag: "td", elClasses: ['fc-list-event-time'], elAttrs: {
                    headers: `${timeHeaderId} ${dateHeaderId}`,
                }, renderProps: renderProps, generatorName: "allDayContent", customGenerator: options.allDayContent, defaultGenerator: renderAllDayInner, classNameGenerator: options.allDayClassNames, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }));
        }
        return (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("td", { className: "fc-list-event-time" }, timeText));
    }
    return null;
}
...
class ListView extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["DateComponent"] {
    constructor() {
        super(...arguments);
        this.computeDateVars = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["memoize"])(computeDateVars);
        this.eventStoreToSegs = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["memoize"])(this._eventStoreToSegs);
        this.state = {
            timeHeaderId: Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["getUniqueDomId"])(),
            eventHeaderId: Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["getUniqueDomId"])(),
            dateHeaderIdRoot: Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["getUniqueDomId"])(),
        };
    ...
    render() {
        ...
        return (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["ViewContainer"], { elRef: this.setRootEl, elClasses: [
                'fc-list',
                context.theme.getClass('table'),
            ...
            Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["Scroller"], { liquid: !props.isHeightAuto, overflowX: props.isHeightAuto ? 'visible' : 'hidden', overflowY: props.isHeightAuto ? 'visible' : 'auto' }, eventSegs.length > 0 ?
    ...
    renderEmptyMessage() {
        ...
        return (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["ContentContainer"], { elTag: "div", elClasses: ['fc-list-empty'], renderProps: renderProps, generatorName: "noEventsContent", customGenerator: options.noEventsContent, defaultGenerator: renderNoEventsInner, classNameGenerator: options.noEventsClassNames, didMount: options.noEventsDidMount, willUnmount: options.noEventsWillUnmount }, (InnerContent) => (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(InnerContent, { elTag: "div", elClasses: ['fc-list-empty-cushion'] }))));
    }
    renderSegList(allSegs, dayDates) {
        let { theme, options } = this.context;
        let { timeHeaderId, eventHeaderId, dateHeaderIdRoot } = this.state;
        let segsByDay = groupSegsByDay(allSegs); // sparse array
        return (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["NowTimer"], { unit: "day" }, (nowDate, todayRange) => {
            let innerNodes = [];
            for (let dayIndex = 0; dayIndex < segsByDay.length; dayIndex += 1) {
                let daySegs = segsByDay[dayIndex];
                if (daySegs) { // sparse array, so might be undefined
                    let dayStr = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["formatDayString"])(dayDates[dayIndex]);
                    let dateHeaderId = dateHeaderIdRoot + '-' + dayStr;
                    // append a day header
                    innerNodes.push(Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(ListViewHeaderRow, { key: dayStr, cellId: dateHeaderId, dayDate: dayDates[dayIndex], todayRange: todayRange }));
                    daySegs = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["sortEventSegs"])(daySegs, options.eventOrder);
                    for (let seg of daySegs) {
                        innerNodes.push(Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(ListViewEventRow, Object.assign({ key: dayStr + ':' + seg.eventRange.instance.instanceId /* are multiple segs for an instanceId */, seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: false, timeHeaderId: timeHeaderId, eventHeaderId: eventHeaderId, dateHeaderId: dateHeaderId }, Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["getSegMeta"])(seg, todayRange, nowDate))));
                    }
                }
            }
            return (Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("table", { className: 'fc-list-table ' + theme.getClass('table') },
                Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("thead", null,
                    Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("tr", null,
                        Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("th", { scope: "col", id: timeHeaderId }, options.timeHint),
                        Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("th", { scope: "col", "aria-hidden": true }),
                        Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("th", { scope: "col", id: eventHeaderId }, options.eventHint))),
                Object(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])("tbody", null, innerNodes)));
        }));
    }
    _eventStoreToSegs(eventStore, eventUiBases, dayRanges) {
        return this.eventRangesToSegs(Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["sliceEventStore"])(eventStore, eventUiBases, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold).fg, dayRanges);
    }
    ...
    eventRangeToSegs(eventRange, dayRanges) {
        ...
        for (dayIndex = 0; dayIndex < dayRanges.length; dayIndex += 1) {
            segRange = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["intersectRanges"])(range, dayRanges[dayIndex]);
            if (segRange) {
                seg = {
                    component: this,
                    eventRange,
...
function computeDateVars(dateProfile) {
    let dayStart = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["startOfDay"])(dateProfile.renderRange.start);
    ...
    while (dayStart < viewEnd) {
        ...
        dayRanges.push({
            start: dayStart,
            end: Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["addDays"])(dayStart, 1),
        });
        dayStart = Object(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__["addDays"])(dayStart, 1);
    }
...
/***/ "./resources/js/fullcalendar-custom.js":
/*!*********************************************!*\
  !*** ./resources/js/fullcalendar-custom.js ***!
  \*********************************************/
/*! no exports provided */
...
function initFullCalendar() {
  // Register plugins
  _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["Calendar"].plugin(_fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_1__["default"], _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_2__["default"], _fullcalendar_list__WEBPACK_IMPORTED_MODULE_3__["default"]);

  // Export Calendar as global variable so it can be accessed in blade templates
  window.FullCalendar = _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["Calendar"];
...
/***/ 1:
/*!***************************************************!*\
  !*** multi ./resources/js/fullcalendar-custom.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\IT Dept\Documents\Project\CI-simapro\resources\js\fullcalendar-custom.js */"./resources/js/fullcalendar-custom.js");
